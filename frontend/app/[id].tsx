...
import { ScrollView, StyleSheet, ActivityIndicator, Image, View, Alert, TouchableOpacity, useColorScheme,Dimensions} from 'react-native';
      ...
      <SafeAreaView edges={['top']} style={{ flex: 1 }}>
        ...
        <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
          ...
          <ThemedText style={styles.dateText}>
            Reported on {report?.created_at ? new Date(report.created_at).toLocaleDateString() : '...'}
          </ThemedText>
          ...
          <View style={styles.imageSection}>
            ...
            {imageUrls.length > 0 ? (
                    ...
                    {imageUrls.map((_, i) => (
                      <View 
                        ...
                        style={[
                          ...
                          { backgroundColor: i === activeIndex ? theme.tint : theme.icon + '30' }
                        ]} 
                      />
                    ))}
                  </View>
              ...
              <View style={styles.placeholderImage}>
                <Ionicons name="lock-closed-outline" size={48} color={theme.icon + '40'} />
